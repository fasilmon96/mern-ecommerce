...
const CreateProductForm = () => {
    ...
    return (
        <motion.div className="bg-gray-800 shadow-lg p-8 rounded-lg mb-8 max-w-xl mx-auto"
        ...
        >
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                    <label htmlFor="name" className="block text-md font-medium text-gray-300">
                        Product Name
                    </label>
                    <input
                        type="text"
                ...
                <button 
                  ...
                  focus:ring-emerald-500 focus:border-emerald-500 disabled:opacity-50"
                  disabled = {loading}
                  >
                 {loading ?(
                   <>
