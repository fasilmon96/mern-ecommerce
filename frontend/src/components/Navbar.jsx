  ...
  return (
    <header className="fixed top-0 left-0 w-full bg-gray-900 bg-opacity-90 backdrop-blur-md shadow-lg z-40
      ...
      <div className="container mx-auto px-4 py-3 flex items-center justify-between">
        ...
        <Link to={'/'} className=" text-lg sm:text-2xl font-bold text-emerald-400 flex items-center">
          E-commerce
        </Link>
        ...
        <nav className="flex items-center gap-4">
          ...
          {user && (
            <Link to={'/cart'} className="relative group flex items-center">
              <ShoppingCart className="mr-1 group-hover:text-emerald-400" size={20} />
          ...
          {user ? (
            ...
            <>
              ...
              <Link to={"/login"} className="bg-gray-700 hover:bg-gray-600 text-white py-2 px-4 rounded-md
                flex items-center transition duration-300 ease-in-out">
                <LogIn size={18} />
